...
matrizBase <- data.frame('Especie'=unique(matrizBasePrem2$Especie), 'Insectivoría'=matrizBase1[,1], "Carnivoría"=matrizBase1[,2],"Hematofagia"=matrizBase1[,3],"Frugivoría"=matrizBase1[,4],"Nectarivoría"=matrizBase1[,5])
...
# Paso 11 - Matriz binaria 2: matrizBinaria2. Similar a la matrizBinaria1, esta matriz codifica las dietas predominantes y estrictas como presentes en la especie, más las dietas complementarias, al igual que las asuentes, las toma como ausentes.

matrizBinaria2 <- data.frame('Especie'=matrizBase$Especie, 'Insectivoría'=0, "Carnivoría"=0,"Hematofagia"=0,"Frugivoría"=0,"Nectarivoría"=0)
...
# Paso 12 - Matriz binaria 3: matrizBinaria3. A diferencia de las matrices matrizBinaria1 y matrizBinaria2, esta matriz solo codificará como presente las dietas estrictas de matrizBase.

matrizBinaria3 <- data.frame('Especie'=matrizBase$Especie, 'Insectivoría'=0, "Carnivoría"=0,"Hematofagia"=0,"Frugivoría"=0,"Nectarivoría"=0)
